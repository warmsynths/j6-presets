...
export class J6App extends LitElement {
  ...
  @state() private activeView: 'preset' | 'chords' | 'styles' = 
    ['preset', 'chords', 'styles'].includes(localStorage.getItem('j6-companion:active-view') || '')
      ? (localStorage.getItem('j6-companion:active-view') as 'preset' | 'chords' | 'styles')
      : 'preset';
  ...
  private handleSwitchClick(e: MouseEvent) {
    ...
    localStorage.setItem('j6-companion:active-view', view);
  }
