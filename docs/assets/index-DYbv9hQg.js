 ...
 */const W=globalThis,ae=W.ShadowRoot&&(W.ShadyCSS===void 0||W.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,re=Symbol(),le=new WeakMap;let Me=class{constructor(e,s,r){if(this._$cssResult$=!0,r!==re)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=s}get styleSheet(){let e=this.o;const s=this.t;if(ae&&e===void 0){const r=s!==void 0&&s.length===1;r&&(e=le.get(s)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),r&&le.set(s,e))}return e}toString(){return this.cssText}};const He=t=>new Me(typeof t=="string"?t:t+"",void 0,re),U=(t,...e)=>{const s=t.length===1?t[0]:e.reduce((r,a,o)=>r+(i=>{if(i._$cssResult$===!0)return i.cssText;if(typeof i=="number")return i;throw Error("Value passed to 'css' function must be a 'css' function result: "+i+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+t[o+1],t[0]);return new Me(s,t,re)},Le=(t,e)=>{if(ae)t.adoptedStyleSheets=e.map(s=>s instanceof CSSStyleSheet?s:s.styleSheet);else for(const s of e){const r=document.createElement("style"),a=W.litNonce;a!==void 0&&r.setAttribute("nonce",a),r.textContent=s.cssText,t.appendChild(r)}},de=ae?t=>t:t=>t instanceof CSSStyleSheet?(e=>{let s="";for(const r of e.cssRules)s+=r.cssText;return He(s)})(t):t;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:Oe,defineProperty:Ie,getOwnPropertyDescriptor:Ge,getOwnPropertyNames:Ne,getOwnPropertySymbols:Te,getPrototypeOf:Be}=Object,k=globalThis,ce=k.trustedTypes,je=ce?ce.emptyScript:"",X=k.reactiveElementPolyfillSupport,N=(t,e)=>t,Y={toAttribute(t,e){switch(e){case Boolean:t=t?je:null;break;case Object:case Array:t=t==null?t:JSON.stringify(t)}return t},fromAttribute(t,e){let s=t;switch(e){case Boolean:s=t!==null;break;case Number:s=t===null?null:Number(t);break;case Object:case Array:try{s=JSON.parse(t)}catch{s=null}}return s}},oe=(t,e)=>!Oe(t,e),pe={attribute:!0,type:String,converter:Y,reflect:!1,useDefault:!1,hasChanged:oe};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),k.litPropertyMetadata??(k.litPropertyMetadata=new WeakMap);let P=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??(this.l=[])).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,s=pe){if(s.state&&(s.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((s=Object.create(s)).wrapped=!0),this.elementProperties.set(e,s),!s.noAccessor){const r=Symbol(),a=this.getPropertyDescriptor(e,r,s);a!==void 0&&Ie(this.prototype,e,a)}}static getPropertyDescriptor(e,s,r){const{get:a,set:o}=Ge(this.prototype,e)??{get(){return this[s]},set(i){this[s]=i}};return{get:a,set(i){const n=a==null?void 0:a.call(this);o==null||o.call(this,i),this.requestUpdate(e,n,r)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??pe}static _$Ei(){if(this.hasOwnProperty(N("elementProperties")))return;const e=Be(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(N("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(N("properties"))){const s=this.properties,r=[...Ne(s),...Te(s)];for(const a of r)this.createProperty(a,s[a])}const e=this[Symbol.metadata];if(e!==null){const s=litPropertyMetadata.get(e);if(s!==void 0)for(const[r,a]of s)this.elementProperties.set(r,a)}this._$Eh=new Map;for(const[s,r]of this.elementProperties){const a=this._$Eu(s,r);a!==void 0&&this._$Eh.set(a,s)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const s=[];if(Array.isArray(e)){const r=new Set(e.flat(1/0).reverse());for(const a of r)s.unshift(de(a))}else e!==void 0&&s.push(de(e));return s}static _$Eu(e,s){const r=s.attribute;return r===!1?void 0:typeof r=="string"?r:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var e;this._$ES=new Promise(s=>this.enableUpdating=s),this._$AL=new Map,this._$E_(),this.requestUpdate(),(e=this.constructor.l)==null||e.forEach(s=>s(this))}addController(e){var s;(this._$EO??(this._$EO=new Set)).add(e),this.renderRoot!==void 0&&this.isConnected&&((s=e.hostConnected)==null||s.call(e))}removeController(e){var s;(s=this._$EO)==null||s.delete(e)}_$E_(){const e=new Map,s=this.constructor.elementProperties;for(const r of s.keys())this.hasOwnProperty(r)&&(e.set(r,this[r]),delete this[r]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Le(e,this.constructor.elementStyles),e}connectedCallback(){var e;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$EO)==null||e.forEach(s=>{var r;return(r=s.hostConnected)==null?void 0:r.call(s)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$EO)==null||e.forEach(s=>{var r;return(r=s.hostDisconnected)==null?void 0:r.call(s)})}attributeChangedCallback(e,s,r){this._$AK(e,r)}_$ET(e,s){var o;const r=this.constructor.elementProperties.get(e),a=this.constructor._$Eu(e,r);if(a!==void 0&&r.reflect===!0){const i=(((o=r.converter)==null?void 0:o.toAttribute)!==void 0?r.converter:Y).toAttribute(s,r.type);this._$Em=e,i==null?this.removeAttribute(a):this.setAttribute(a,i),this._$Em=null}}_$AK(e,s){var o,i;const r=this.constructor,a=r._$Eh.get(e);if(a!==void 0&&this._$Em!==a){const n=r.getPropertyOptions(a),l=typeof n.converter=="function"?{fromAttribute:n.converter}:((o=n.converter)==null?void 0:o.fromAttribute)!==void 0?n.converter:Y;this._$Em=a;const d=l.fromAttribute(s,n.type);this[a]=d??((i=this._$Ej)==null?void 0:i.get(a))??d,this._$Em=null}}requestUpdate(e,s,r,a=!1,o){var i;if(e!==void 0){const n=this.constructor;if(a===!1&&(o=this[e]),r??(r=n.getPropertyOptions(e)),!((r.hasChanged??oe)(o,s)||r.useDefault&&r.reflect&&o===((i=this._$Ej)==null?void 0:i.get(e))&&!this.hasAttribute(n._$Eu(e,r))))return;this.C(e,s,r)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,s,{useDefault:r,reflect:a,wrapped:o},i){r&&!(this._$Ej??(this._$Ej=new Map)).has(e)&&(this._$Ej.set(e,i??s??this[e]),o!==!0||i!==void 0)||(this._$AL.has(e)||(this.hasUpdated||r||(s=void 0),this._$AL.set(e,s)),a===!0&&this._$Em!==e&&(this._$Eq??(this._$Eq=new Set)).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(s){Promise.reject(s)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var r;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[o,i]of this._$Ep)this[o]=i;this._$Ep=void 0}const a=this.constructor.elementProperties;if(a.size>0)for(const[o,i]of a){const{wrapped:n}=i,l=this[o];n!==!0||this._$AL.has(o)||l===void 0||this.C(o,void 0,i,l)}}let e=!1;const s=this._$AL;try{e=this.shouldUpdate(s),e?(this.willUpdate(s),(r=this._$EO)==null||r.forEach(a=>{var o;return(o=a.hostUpdate)==null?void 0:o.call(a)}),this.update(s)):this._$EM()}catch(a){throw e=!1,this._$EM(),a}e&&this._$AE(s)}willUpdate(e){}_$AE(e){var s;(s=this._$EO)==null||s.forEach(r=>{var a;return(a=r.hostUpdated)==null?void 0:a.call(r)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&(this._$Eq=this._$Eq.forEach(s=>this._$ET(s,this[s]))),this._$EM()}updated(e){}firstUpdated(e){}};P.elementStyles=[],P.shadowRootOptions={mode:"open"},P[N("elementProperties")]=new Map,P[N("finalized")]=new Map,X==null||X({ReactiveElement:P}),(k.reactiveElementVersions??(k.reactiveElementVersions=[])).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const T=globalThis,he=t=>t,V=T.trustedTypes,ue=V?V.createPolicy("lit-html",{createHTML:t=>t}):void 0,ke="$lit$",M=`lit$${Math.random().toFixed(9).slice(2)}$`,_e="?"+M,Re=`<${_e}>`,A=document,B=()=>A.createComment(""),j=t=>t===null||typeof t!="object"&&typeof t!="function",ie=Array.isArray,qe=t=>ie(t)||typeof(t==null?void 0:t[Symbol.iterator])=="function",Z=`[ 	
\f\r]`,G=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,me=/-->/g,ge=/>/g,C=RegExp(`>|${Z}(?:([^\\s"'>=/]+)(${Z}*=${Z}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),fe=/'/g,be=/"/g,Se=/^(?:script|style|textarea|title)$/i,ze=t=>(e,...s)=>({_$litType$:t,strings:e,values:s}),h=ze(1),H=Symbol.for("lit-noChange"),g=Symbol.for("lit-nothing"),ve=new WeakMap,F=A.createTreeWalker(A,129);function Ce(t,e){if(!ie(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return ue!==void 0?ue.createHTML(e):e}const We=(t,e)=>{const s=t.length-1,r=[];let a,o=e===2?"<svg>":e===3?"<math>":"",i=G;for(let n=0;n<s;n++){const l=t[n];let d,c,p=-1,b=0;for(;b<l.length&&(i.lastIndex=b,c=i.exec(l),c!==null);)b=i.lastIndex,i===G?c[1]==="!--"?i=me:c[1]!==void 0?i=ge:c[2]!==void 0?(Se.test(c[2])&&(a=RegExp("</"+c[2],"g")),i=C):c[3]!==void 0&&(i=C):i===C?c[0]===">"?(i=a??G,p=-1):c[1]===void 0?p=-2:(p=i.lastIndex-c[2].length,d=c[1],i=c[3]===void 0?C:c[3]==='"'?be:fe):i===be||i===fe?i=C:i===me||i===ge?i=G:(i=C,a=void 0);const v=i===C&&t[n+1].startsWith("/>")?" ":"";o+=i===G?l+Re:p>=0?(r.push(d),l.slice(0,p)+ke+l.slice(p)+M+v):l+M+(p===-2?n:v)}return[Ce(t,o+(t[s]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),r]};class R{constructor({strings:e,_$litType$:s},r){let a;this.parts=[];let o=0,i=0;const n=e.length-1,l=this.parts,[d,c]=We(e,s);if(this.el=R.createElement(d,r),F.currentNode=this.el.content,s===2||s===3){const p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(a=F.nextNode())!==null&&l.length<n;){if(a.nodeType===1){if(a.hasAttributes())for(const p of a.getAttributeNames())if(p.endsWith(ke)){const b=c[i++],v=a.getAttribute(p).split(M),D=/([.?@])?(.*)/.exec(b);l.push({type:1,index:o,name:D[2],strings:v,ctor:D[1]==="."?Ve:D[1]==="?"?Ue:D[1]==="@"?Je:J}),a.removeAttribute(p)}else p.startsWith(M)&&(l.push({type:6,index:o}),a.removeAttribute(p));if(Se.test(a.tagName)){const p=a.textContent.split(M),b=p.length-1;if(b>0){a.textContent=V?V.emptyScript:"";for(let v=0;v<b;v++)a.append(p[v],B()),F.nextNode(),l.push({type:2,index:++o});a.append(p[b],B())}}}else if(a.nodeType===8)if(a.data===_e)l.push({type:2,index:o});else{let p=-1;for(;(p=a.data.indexOf(M,p+1))!==-1;)l.push({type:7,index:o}),p+=M.length-1}o++}}static createElement(e,s){const r=A.createElement("template");return r.innerHTML=e,r}}function L(t,e,s=t,r){var i,n;if(e===H)return e;let a=r!==void 0?(i=s._$Co)==null?void 0:i[r]:s._$Cl;const o=j(e)?void 0:e._$litDirective$;return(a==null?void 0:a.constructor)!==o&&((n=a==null?void 0:a._$AO)==null||n.call(a,!1),o===void 0?a=void 0:(a=new o(t),a._$AT(t,s,r)),r!==void 0?(s._$Co??(s._$Co=[]))[r]=a:s._$Cl=a),a!==void 0&&(e=L(t,a._$AS(t,e.values),a,r)),e}class Ye{constructor(e,s){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=s}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:s},parts:r}=this._$AD,a=((e==null?void 0:e.creationScope)??A).importNode(s,!0);F.currentNode=a;let o=F.nextNode(),i=0,n=0,l=r[0];for(;l!==void 0;){if(i===l.index){let d;l.type===2?d=new q(o,o.nextSibling,this,e):l.type===1?d=new l.ctor(o,l.name,l.strings,this,e):l.type===6&&(d=new Qe(o,this,e)),this._$AV.push(d),l=r[++n]}i!==(l==null?void 0:l.index)&&(o=F.nextNode(),i++)}return F.currentNode=A,a}p(e){let s=0;for(const r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(e,r,s),s+=r.strings.length-2):r._$AI(e[s])),s++}}class q{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,s,r,a){this.type=2,this._$AH=g,this._$AN=void 0,this._$AA=e,this._$AB=s,this._$AM=r,this.options=a,this._$Cv=(a==null?void 0:a.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const s=this._$AM;return s!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=s.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,s=this){e=L(this,e,s),j(e)?e===g||e==null||e===""?(this._$AH!==g&&this._$AR(),this._$AH=g):e!==this._$AH&&e!==H&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):qe(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==g&&j(this._$AH)?this._$AA.nextSibling.data=e:this.T(A.createTextNode(e)),this._$AH=e}$(e){var o;const{values:s,_$litType$:r}=e,a=typeof r=="number"?this._$AC(e):(r.el===void 0&&(r.el=R.createElement(Ce(r.h,r.h[0]),this.options)),r);if(((o=this._$AH)==null?void 0:o._$AD)===a)this._$AH.p(s);else{const i=new Ye(a,this),n=i.u(this.options);i.p(s),this.T(n),this._$AH=i}}_$AC(e){let s=ve.get(e.strings);return s===void 0&&ve.set(e.strings,s=new R(e)),s}k(e){ie(this._$AH)||(this._$AH=[],this._$AR());const s=this._$AH;let r,a=0;for(const o of e)a===s.length?s.push(r=new q(this.O(B()),this.O(B()),this,this.options)):r=s[a],r._$AI(o),a++;a<s.length&&(this._$AR(r&&r._$AB.nextSibling,a),s.length=a)}_$AR(e=this._$AA.nextSibling,s){var r;for((r=this._$AP)==null?void 0:r.call(this,!1,!0,s);e!==this._$AB;){const a=he(e).nextSibling;he(e).remove(),e=a}}setConnected(e){var s;this._$AM===void 0&&(this._$Cv=e,(s=this._$AP)==null||s.call(this,e))}}class J{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,s,r,a,o){this.type=1,this._$AH=g,this._$AN=void 0,this.element=e,this.name=s,this._$AM=a,this.options=o,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=g}_$AI(e,s=this,r,a){const o=this.strings;let i=!1;if(o===void 0)e=L(this,e,s,0),i=!j(e)||e!==this._$AH&&e!==H,i&&(this._$AH=e);else{const n=e;let l,d;for(e=o[0],l=0;l<o.length-1;l++)d=L(this,n[r+l],s,l),d===H&&(d=this._$AH[l]),i||(i=!j(d)||d!==this._$AH[l]),d===g?e=g:e!==g&&(e+=(d??"")+o[l+1]),this._$AH[l]=d}i&&!a&&this.j(e)}j(e){e===g?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class Ve extends J{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===g?void 0:e}}class Ue extends J{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==g)}}class Je extends J{constructor(e,s,r,a,o){super(e,s,r,a,o),this.type=5}_$AI(e,s=this){if((e=L(this,e,s,0)??g)===H)return;const r=this._$AH,a=e===g&&r!==g||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,o=e!==g&&(r===g||a);a&&this.element.removeEventListener(this.name,this,r),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var s;typeof this._$AH=="function"?this._$AH.call(((s=this.options)==null?void 0:s.host)??this.element,e):this._$AH.handleEvent(e)}}class Qe{constructor(e,s,r){this.element=e,this.type=6,this._$AN=void 0,this._$AM=s,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(e){L(this,e)}}const ee=T.litHtmlPolyfillSupport;ee==null||ee(R,q),(T.litHtmlVersions??(T.litHtmlVersions=[])).push("3.3.3");const Ke=(t,e,s)=>{const r=(s==null?void 0:s.renderBefore)??e;let a=r._$litPart$;if(a===void 0){const o=(s==null?void 0:s.renderBefore)??null;r._$litPart$=a=new q(e.insertBefore(B(),o),o,void 0,s??{})}return a._$AI(t),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const E=globalThis;class _ extends P{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var s;const e=super.createRenderRoot();return(s=this.renderOptions).renderBefore??(s.renderBefore=e.firstChild),e}update(e){const s=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Ke(s,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return H}}var we;_._$litElement$=!0,_.finalized=!0,(we=E.litElementHydrateSupport)==null||we.call(E,{LitElement:_});const te=E.litElementPolyfillSupport;te==null||te({LitElement:_});(E.litElementVersions??(E.litElementVersions=[])).push("4.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
Voicing: ${e.join(", ")}`:`Chord: ${t}`;navigator.clipboard.writeText(s).then(()=>{})}};y.styles=U`
    :host {
      display: block;
      color: var(--text-primary);
      font-family: var(--font-sans);
  ...
  `;S([u()],y.prototype,"searchQuery",2);S([u()],y.prototype,"selectedGenre",2);S([u()],y.prototype,"maxComplexity",2);S([u()],y.prototype,"currentFilteredIndex",2);S([u()],y.prototype,"showSearchModal",2);S([u()],y.prototype,"showComplexHelpModal",2);S([u()],y.prototype,"genreFilterCollapsed",2);y=S([Q("j6-chords-view")],y);const ft=[{category_name:"Arpeggio Styles",description:"Melodic motion using single-note arpeggios. Traces the chord's notes in time rather than holding them as a block.",styles:[{style_number:1,style_name:"Classic 8th-Note Arpeggios",subdivision:"8th-note",variations:[{var:1,pattern:"UP1",description:"8th, ascending",use_case:"Bright rising bassline or lead; good opening phrase"},{var:2,pattern:"UP&DOWN1",description:"8th, up/down",use_case:"Balanced melodic motion for evolving chords"},{var:3,pattern:"DOWN1",description:"8th, descending",use_case:"Falling bassline; moody transitions"},{var:4,pattern:"DOWN2",description:"8th, alt. descent",use_case:"Descending variation, added rhythmic interest"},{var:5,pattern:"UP&DOWN2",description:"8th, alt.",use_case:"Double-direction motion under sustained chords"},{var:6,pattern:"UP2",description:"8th, alt. ascend",use_case:"Faster upward arps for energetic sections"},{var:"7-12",pattern:"Triplet versions of 1-6",description:"8th-note triplets",use_case:"Swing / shuffle feel; funk or jazz-leaning parts"}]},{style_number:2,style_name:"16th-Note Arpeggio Motion",subdivision:"16th-note",variations:[{var:1,pattern:"UP1",description:"16th, ascending",use_case:"Fast rhythmic lead or bass figure"},{var:2,pattern:"UP&DOWN1",description:"16th, up/down",use_case:"Busy, pulsing arpeggio motion"},{var:3,pattern:"DOWN1",description:"16th, descending",use_case:"Quick descending fills"},{var:4,pattern:"DOWN2",description:"16th, alt. descent",use_case:"Slightly varied downward feel"},{var:5,pattern:"UP&DOWN2",description:"16th, alt.",use_case:"Complex bidirectional lines"},{var:6,pattern:"UP2",description:"16th, alt. ascend",use_case:"High-energy melodic runs"},{var:"7-12",pattern:"16th triplet versions",description:"16th-note triplets",use_case:"Groove-oriented arps with swing"}]},{style_number:3,style_name:"Stepped Note Arpeggios",subdivision:"Variable (Spacious)",note:"Documented under 'BEAT' in the official manual, grouped here by sonic character.",variations:[{var:1,note_value:"Double whole note",use_case:"Very slow motion under ambient pads"},{var:2,note_value:"Whole note",use_case:"Slow arpeggio fills"},{var:3,note_value:"Half note",use_case:"Broader melodic pacing"},{var:4,note_value:"Quarter note",use_case:"Subtle motion under chords"},{var:5,note_value:"Eighth note",use_case:"Moderate arpeggio pacing"},{var:6,note_value:"Sixteenth note",use_case:"Faster but still spaced motion"},{var:"7-12",note_value:"Triplet versions of 1-6",use_case:"Varied rhythmic feel with swing"}]}]},{category_name:"Beat Styles",description:"Rhythmic gating of the chord. The whole chord gates on and off on specific positions. Prioritizes timing over melodic motion.",styles:[{style_number:4,style_name:"Basic Rhythmic Patterns",variations:[{var:1,pattern:"o",description:"16th hit, rest",use_case:"Simple rhythmic stab under pads"},{var:2,pattern:"_o",description:"Syncopated 16th",use_case:"Off-beat accents in grooves"},{var:3,pattern:"_o_",description:"Late 16th",use_case:"Delay-like rhythmic feel"},{var:4,pattern:"o",description:"Very late 16th",use_case:"Sparse late hits"},{var:5,pattern:"~o_",description:"8th + 16th",use_case:"Groove with uneven feel"},{var:6,pattern:"o_o~",description:"8th/16th syncopation",use_case:"More complex rhythm"},{var:"7-12",pattern:"16th groupings",description:"Various 16th configurations",use_case:"Varied rhythmic punctuations"}]},{style_number:5,style_name:"Syncopated Rhythmic Motion",variations:[{var:1,pattern:"o",description:"Sync 16th",use_case:"Strong starter hits under chords"},{var:2,pattern:"o_o_",description:"Syncopated 16ths",use_case:"Funky, off-beat chord drive"},{var:3,pattern:"o_o",description:"Paired 16ths",use_case:"Repeating rhythmic pushes"},{var:4,pattern:"_oo_",description:"Clustered rhythmic accents",use_case:"Clustered rhythmic accents"},{var:5,pattern:"_o_o",description:"Offset sync",use_case:"Jumpier rhythm"},{var:6,pattern:"oo",description:"Tight 16th pair",use_case:"Fast rhythmic duet"},{var:"7-12",pattern:"Extended sync groupings",description:"Extended syncopation",use_case:"More sync accent feel"}]}]},{category_name:"Chord / Phrase Styles",description:"The chord moves as a block unit (rhythmic comping or strums) rather than breaking into single notes.",note:"No per-variation breakdown is published officially; variations 1-12 must be auditioned by ear.",styles:[{style_number:6,style_name:"Chord Phrases (Simple)",use_case:"Basic chord backing, predictable motion. Variation 1 is the best candidate for a 'plain' held chord.",variations:[{var:"1-12",pattern:"Unpublished",use_case:"Predictable block harmonic motion"}]},{style_number:7,style_name:"Chord Phrases (Rhythmic)",use_case:"Groove chords that move with beat emphasis.",variations:[{var:"1-12",pattern:"Unpublished",use_case:"Pulsing, groove-oriented block chords"}]},{style_number:8,style_name:"Strummed Chord Phrases (Simple)",use_case:"Acoustic-like backing or rhythmic pulse simulating guitar or piano comping.",variations:[{var:"1-12",pattern:"Unpublished",use_case:"Strum-like acoustic simulation"}]},{style_number:9,style_name:"Strummed Chord Phrases (Rhythmic)",use_case:"More pronounced groove and swing added to the strummed character.",variations:[{var:"1-12",pattern:"Unpublished",use_case:"Strumming with pronounced groove/swing"}]}]}],bt={style_categories:ft};var vt=Object.defineProperty,xt=Object.getOwnPropertyDescriptor,K=(t,e,s,r)=>{for(var a=r>1?void 0:r?xt(e,s):e,o=t.length-1,i;o>=0;o--)(i=t[o])&&(a=(r?i(e,s,a):i(a))||a);return r&&a&&vt(e,s,a),a};const xe=bt;let O=class extends _{constructor(){super(...arguments),this.selectedCategoryIndex=0,this.selectedStyleIndex=0,this.selectedVariationIndex=0}get currentCategory(){return xe.style_categories[this.selectedCategoryIndex]}get currentStyle(){return this.currentCategory.styles[this.selectedStyleIndex]}get currentVariation(){return this.currentStyle.variations[this.selectedVariationIndex]}setCategory(t){this.selectedCategoryIndex=t,this.selectedStyleIndex=0,this.selectedVariationIndex=0}cycleStyle(t){const e=this.currentCategory.styles.length;if(e<=1)return;let s=this.selectedStyleIndex+t;s<0&&(s=e-1),s>=e&&(s=0),this.selectedStyleIndex=s,this.selectedVariationIndex=0}cycleVariation(t){const e=this.currentStyle.variations.length;if(e<=1)return;let s=this.selectedVariationIndex+t;s<0&&(s=e-1),s>=e&&(s=0),this.selectedVariationIndex=s}renderStepGrid(t,e,s){const r=(t||"").toUpperCase(),a=e.toLowerCase(),o=(s||"").toLowerCase(),i=8;let n=8;o.includes("16th")?n=16:(o.includes("variable")||o.includes("spacious"))&&(n=4),r.includes("TRIPLET")&&(n=12);const l=Array.from({length:i},()=>Array(n).fill(!1));if(a.includes("chord")||a.includes("phrase"))if(r.includes("STRUM")){const d=[0,1,Math.floor(n/2),Math.floor(n/2)+1];for(const c of d)c<n&&(l[2][c]=!0,l[3][c]=!0,l[4][c]=!0,l[5][c]=!0)}else if(r.includes("RHYTHMIC")||r.includes("GROOVE")){const d=Math.max(1,Math.floor(n/4));for(let c=0;c<4;c++){const p=c*d;p<n&&(l[2][p]=!0,l[3][p]=!0,l[4][p]=!0,l[5][p]=!0)}}else{const d=Math.max(1,Math.floor(n/4));for(let c=0;c<4;c++){const p=c*d;p<n&&(l[2][p]=!0,l[3][p]=!0,l[4][p]=!0,l[5][p]=!0)}}else if(a.includes("beat"))if(r.includes("SYNC")||r.includes("SYNCO"))for(let d=0;d<n;d++)d%2===1&&(l[3][d]=!0),d%2===0&&(l[4][d]=!0);else if(r.includes("_O"))for(let d=1;d<n;d+=Math.max(2,Math.floor(n/4)))l[3][d]=!0,l[4][d]=!0;else{const d=Math.max(1,Math.floor(n/4));for(let c=0;c<n;c+=d)l[3][c]=!0,l[4][c]=!0}else if(r.includes("UP&DOWN")||r.includes("U/D")||r.includes("ALT")){const d=Math.floor(n/2);for(let c=0;c<n;c++){const p=c<d?7-Math.floor(c/d*6):1+Math.floor((c-d)/(n-d-1||1)*6);l[Math.min(7,Math.max(0,p))][c]=!0}}else if(r.includes("DOWN&UP")||r.includes("D/U")){const d=Math.floor(n/2);for(let c=0;c<n;c++){const p=c<d?1+Math.floor(c/d*6):7-Math.floor((c-d)/(n-d-1||1)*6);l[Math.min(7,Math.max(0,p))][c]=!0}}else if(r.includes("DOWN"))for(let d=0;d<n;d++){const c=Math.min(7,Math.floor(d/(n-1)*7));l[c][d]=!0}else if(r.includes("UP"))for(let d=0;d<n;d++){const c=Math.min(7,7-Math.floor(d/(n-1)*7));l[c][d]=!0}else if(r.includes("RANDOM")||r.includes("RND")){const d=[2,6,1,5,3,7,0,4,3,5,1,6,2,7,4,0];for(let c=0;c<n;c++)l[d[c%d.length]][c]=!0}else if(r.includes("TRIPLET"))[7,5,3,6,4,2,5,3,1,4,2,0].forEach((c,p)=>{p<n&&(l[c][p]=!0)});else if(r.includes("UNPUBLISHED")||r==="")l[1][Math.floor(n/2)-1]=!0,l[1][Math.floor(n/2)]=!0,l[2][Math.floor(n/2)+1]=!0,l[3][Math.floor(n/2)]=!0,l[4][Math.floor(n/2)-1]=!0,l[6][Math.floor(n/2)-1]=!0,l[6][Math.floor(n/2)]=!0;else for(let d=0;d<n;d++){const c=Math.min(7,7-Math.floor(d/(n-1)*7));l[c][d]=!0}return h`
      <div class="step-grid" style="grid-template-columns: repeat(${n}, 1fr)">
        ${l.map(d=>h`
          ${d.map(c=>h`
            <div class="step-cell ${c?"on":""}"></div>
          `)}
        `)}
      </div>
    `}render(){const t=this.currentCategory,e=this.currentStyle,s=this.currentVariation;return h`
      <div class="synth-panel">
        ...
        <div class="controls-section">
          ...
          <div class="control-block">
            <div class="hw-category-container">
              ${xe.style_categories.map((r,a)=>h`
                <div class="hw-btn-group" @click=${()=>this.setCategory(a)}>
                  <div class="hw-btn-label">${r.category_name.split(" ")[0]}</div>
                  <div class="hw-btn-led ${this.selectedCategoryIndex===a?"on":""}"></div>
                  <div class="hw-btn-square ${this.selectedCategoryIndex===a?"active":""}"></div>
                </div>
              `)}
            </div>
          </div>
          ...
          <div class="control-block">
            ...
            <div class="stepper">
              ...
              <div class="stepper-readout">[${e.style_number}]</div>
              <button class="btn-rubber" @click=${()=>this.cycleStyle(1)}>&gt;</button>
            </div>
            <div class="control-subtext" title="${e.style_name}">
              ${e.style_name}
            </div>
          </div>
          ...
          <div class="control-block">
            ...
            <div class="control-subtext" title="${s.pattern||s.note_value}">
              <strong>${s.pattern||s.note_value||"Unpublished"}</strong>
            </div>
          </div>
        ...
        <div class="display-section">
          ...
          <div class="oscilloscope-screen">
            ${this.renderStepGrid(s.pattern||s.note_value,t.category_name,e.subdivision)}
          </div>

          <div class="details-panel">
            <div class="details-header">VARIATION INFO</div>
            <div class="details-desc">${s.description}</div>
            <div class="details-usecase">${s.use_case}</div>
          </div>
  ...
  `;K([u()],O.prototype,"selectedCategoryIndex",2);K([u()],O.prototype,"selectedStyleIndex",2);K([u()],O.prototype,"selectedVariationIndex",2);O=K([Q("j6-styles-view")],O);var yt=Object.defineProperty,wt=Object.getOwnPropertyDescriptor,$=(t,e,s,r)=>{for(var a=r>1?void 0:r?wt(e,s):e,o=t.length-1,i;o>=0;o--)(i=t[o])&&(a=(r?i(e,s,a):i(a))||a);return r&&a&&yt(e,s,a),a};const ye=et.map(t=>({...t,id:t.bankPatch,name:t.soundNameCategory,notes:t.notesDescription||"",delayEffects:t.delayReverb,tags:st(t)}));let w=class extends _{constructor(){super(...arguments),this.selectedPreset=ye[0],this.presetListOpen=!1,this.aboutOpen=!1,this.isEdited=!1,this.activeView=["preset","chords","styles"].includes(localStorage.getItem("j6-companion:active-view")||"")?localStorage.getItem("j6-companion:active-view"):"preset",this.customValues={}}willUpdate(t){t.has("selectedPreset")&&this.resetToPresetValues()}resetToPresetValues(){const t=this.selectedPreset;this.customValues={lfo:lt(t.lfo),pwm:dt(t.pwm),a:se(t.attack),d:se(t.decay),s:rt(t.sustain),r:se(t.release),freq:ot(t.filterFreq),res:it(t.resonance),env:nt(t.envMod),effect:t.chorus!=="Off"?70:0,delay:t.delayReverb==="Y"?60:0,reverb:t.delayReverb==="Y"?50:0},this.isEdited=!1}handleFaderMouseDown(t,e){t.preventDefault();const s=t.currentTarget.querySelector(".fader-track");this.updateFaderFromCoord(t.clientY,s,e);const r=o=>{this.updateFaderFromCoord(o.clientY,s,e)},a=()=>{window.removeEventListener("mousemove",r),window.removeEventListener("mouseup",a)};window.addEventListener("mousemove",r),window.addEventListener("mouseup",a)}handleFaderTouchStart(t,e){const s=t.currentTarget.querySelector(".fader-track");this.updateFaderFromCoord(t.touches[0].clientY,s,e);const r=o=>{this.updateFaderFromCoord(o.touches[0].clientY,s,e)},a=()=>{window.removeEventListener("touchmove",r),window.removeEventListener("touchend",a)};window.addEventListener("touchmove",r),window.addEventListener("touchend",a)}handleSwitchClick(t){const e=t.currentTarget.getBoundingClientRect(),s=t.clientX-e.left,r=e.width/3;let a="preset";s<r?a="preset":s<r*2?a="chords":a="styles",this.activeView=a,localStorage.setItem("j6-companion:active-view",a)}updateFaderFromCoord(t,e,s){const r=e.getBoundingClientRect(),a=Math.max(0,Math.min(1,(r.bottom-t)/r.height)),o=Math.round(a*100);this.customValues={...this.customValues,[s]:o},this.isEdited=!0}handleKnobMouseDown(t,e){t.preventDefault();const s=t.clientY,r=this.customValues[e]||0,a=i=>{const l=(s-i.clientY)*1.2,d=Math.max(0,Math.min(100,r+l));this.customValues={...this.customValues,[e]:Math.round(d)},this.isEdited=!0},o=()=>{window.removeEventListener("mousemove",a),window.removeEventListener("mouseup",o)};window.addEventListener("mousemove",a),window.addEventListener("mouseup",o)}handleSendGet(){const t=`--- Roland J-6 Patch Info ---
...
---------------------------------------`;navigator.clipboard.writeText(t).then(()=>{alert("Patch dump copied to clipboard successfully!")})}renderFader(t,e,s){return h`
    ...
    `}render(){const t=this.selectedPreset,e=t.saw==="SAW",s=t.pulse==="SQU"||t.pulse==="PWM",r=["15%","20%","25%","33%"].includes(t.pulse),a=["100%","25%"].includes(t.sub),o=t.sub==="50%",i=t.noise!=="x",n=t.chorus==="Off"||!t.chorus,l=t.chorus==="I",d=t.chorus==="II",c=(this.customValues.a||0)*.25,p=(this.customValues.d||0)*.25,b=(this.customValues.s||0)*.4,v=25,D=(this.customValues.r||0)*.25,Fe="0,40",Ee=`${c},0`,Ae=`${c+p},${40-b}`,$e=`${c+p+v},${40-b}`,De=`${c+p+v+D},40`,Pe=`M ${Fe} L ${Ee} L ${Ae} L ${$e} L ${De}`;return h`
      <div class="synth-container">
                  ...
                  <div class="patch-top-row">
                    ...
                    <div class="led-search-screen" style="padding: 0; overflow: hidden; justify-content: center;">
                      <svg viewBox="0 0 100 40" style="width: 90%; height: 80%; overflow: visible;" preserveAspectRatio="none">
                        <path d=${Pe} fill="none" stroke="var(--color-orange-primary)" stroke-width="2" vector-effect="non-scaling-stroke" filter="drop-shadow(0 0 4px rgba(255, 93, 0, 0.7))"/>
                      </svg>
                    </div>
                  </div>
        ...
        <div class="synth-footer">
          <a href="https://github.com/warmsynths/j6-companion" target="_blank" rel="noopener noreferrer">
  ...
  `;$([u()],w.prototype,"selectedPreset",2);$([u()],w.prototype,"presetListOpen",2);$([u()],w.prototype,"aboutOpen",2);$([u()],w.prototype,"isEdited",2);$([u()],w.prototype,"activeView",2);$([u()],w.prototype,"customValues",2);w=$([Q("j6-app")],w);
